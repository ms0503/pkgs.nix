...
}:
{
  ...
  noto-fonts = {
    ...
    version = "2026.01.01";
    src = fetchurl {
      url = "https://github.com/notofonts/notofonts.github.io/archive/refs/tags/noto-monthly-release-2026.01.01.tar.gz";
      sha256 = "sha256-8b7A3XIvz8sKp1yANTDjqK5ODdWeW5OlLdj1fVSU70Q=";
    };
  };
  proton-ge-rtsp-bin = {
